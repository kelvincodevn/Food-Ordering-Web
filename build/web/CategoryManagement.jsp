                        ...
                        <div class="col-md-12">
                            <div class="table-wrapper">
                                ...
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                            <h2 class="ml-lg-2">Manage  Category</h2>
                                        </div>
                                ...
                                <%
                                    ...
                                    List<ItemCategoryDTO> listCategory = dao.getAllItemCategory(); 
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <%
                                            for (ItemCategoryDTO category : listCategory) {
                                        %> 
                                        <tr>
                                            <th><span class="custom-checkbox">
                                                    <input type="checkbox" id="checkbox1" name="option[]" value="1">
                                                    <label for="checkbox1"></label></th>
                                            <th><%=category.getCategoryID()%></th>
                                            <th><%=category.getCategoryName()%></th>
                                            <th><%=category.getCategoryDescription()%></th>
                                            <th>
