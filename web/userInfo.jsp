...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <header class="header_section">
      <div class="container">
        ...
        %>
             <div class="nav-item">
                <span class="nav-link" style="color: white" ><%=fullName%></span>
             </div>
            </div>
          </div>
        </nav>
  ...
  <%
                  ...
                  errors =(ErrorRegistration) request.getAttribute("ERRORS");
                  if(errors!=null){
  ...
  <section class="book_section layout_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form_container">
            <form action="MainController" method="POST">
              ...
              <div>
                  <span>Full name</span><font color="red"> ${requestScope.ERRORS.fullNameLenError}</font>
                   <input type="hidden" name="UpdateUserID" value="<%=userNameID%>"/>
                  <input type="text" class="form-control" name="UpdateFullName" value="<%=fullName%>"/>
              </div>
                <div>
                    <span>Email</span><font color="red"> ${requestScope.ERRORS.emailValidationError}</font>
                    <input type="email" class="form-control" name="UpdateEmail" value="<%=email%>" />
              </div>
              <div>
                  <span>Phone number</span><font color="red"> ${requestScope.ERRORS.phoneValidationError}</font>
                <input type="text" class="form-control" name="UpdatePhoneNumber" value="<%=phoneNumber%>"/>
              </div>
              <div>
                  <span>User name</span>
                  <input type="text" class="form-control" name="UpdateUserName" value="<%=userName%>" />
              </div>
                
                <div>
                    <span>Password</span><font color="red"> ${requestScope.ERRORS.passwordLenError}</font>
                    <input type="password" class="form-control" name="UpdatePassword" value="<%=password%>" />
              </div>

              <div class="btn_box">
                <button>
                  <input type="submit" name="btAction" value="Update information"/>
                </button>
              </div>
        ...
        <div class="col-md-6">
            <image src="images/pic_info.jpg" style="width: 830px"/>
        </div>
      </div>
    </div>
  </section>
